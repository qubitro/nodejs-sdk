...
var Project = /** @class */ (function () {
    function Project(id, name, description, created_at) {
        this.id = id;
        this.name = name;
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.delete("https://api.qubitro.com/v2/projects/".concat(this.id), {
                                headers: {
...
function getProjects() {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var response, projects_1, body, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.get("https://api.qubitro.com/v2/projects", {
                            headers: {
                                Authorization: (0, Config_1.getConf)().apikey ? "Bearer ".concat((0, Config_1.getConf)().apikey) : ''
                            }
                        })];
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.get("https://api.qubitro.com/v2/projects/".concat(projectID), {
                            headers: {
                                Authorization: (0, Config_1.getConf)().apikey ? "Bearer ".concat((0, Config_1.getConf)().apikey) : ''
                            }
                        })];
